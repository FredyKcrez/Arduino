...
Fecha de creación de Sketch: 10-Mayo-2016
ultima modificación del Sketch: 13-Mayo-2016
*********************************************************************/

/*
 * Objetivo: Este sketch permite envia notificaciones a la red social Twitter cuando el
 * valor leido desde un potenciometro supera el valor de 3.4V.
 */
 ...
 * http://arduinodhernandez.blogspot.com/2015/06/detectar-humedadtemperatura-y-notificar.html
 */
...
// Message to post
String msg = "Se ha superado la lectura de 3.4V.";
