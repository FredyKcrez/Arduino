...
void setup()
{
  ...
  if(!SD.exists("index1.htm")) {  // Comprobamos que exista el archivo index.htm
...
void XML_response(EthernetClient cl)
{
    ...
    cl.print(F("</analog2>"));
    cl.print(F("<val>"));
    cl.print(map(pinA0, 0, 1023, 0, 255));
    cl.print(F("</val>"));
    cl.print(F("<val1>"));
    cl.print(map(pinA1, 0, 1023, 0, 255));
    cl.print(F("</val1>"));
    cl.print(F("<val2>"));
    cl.print(map(pinA2, 0, 1023, 0, 255));
    cl.print(F("</val2>"));
    cl.print(F("</inputs>"));
}
